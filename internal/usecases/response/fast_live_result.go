...
type FastElectionResultsResponse struct {
...
type FastCityResultsResponse struct {
...
type FastElectionSummaryResponse struct {
	ElectionID          string    `json:"election_id"`
...
type FastCityRankingsResponse struct {
	ElectionID  string            `json:"election_id"`
...
type FastAllElectionsSummaryResponse struct {
	Elections      []FastElectionSummaryResponse `json:"elections"`
	LastUpdated    time.Time                     `json:"last_updated"`
